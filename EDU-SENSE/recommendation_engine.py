...
class RecommendationEngine:
    ...
    def _recommend_concept_review(self, gap_name: str, gap_details: Dict) -> Dict:
        ...
        # Add library resources if available
        ...
        # Add subject-based resources
        topic_resources = get_resources_for_topic(topic_display)
        if topic_resources:
            resources['Learning Resources'] = topic_resources
        ...
        return {
            ...
            'duration': duration,
            'expected_impact': gap_details.get('expected_impact', 0.25), # Use impact from gap_details or default
            'steps': [
            ...
            'resources': resources # Add resources here
        }
